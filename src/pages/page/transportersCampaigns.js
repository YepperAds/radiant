...
// Import components
import SearchBar from '../container/transportComponents/SearchBar';
import TabFilter from '../container/transportComponents/TabFilter';
import AllPlatformsView from '../container/transportComponents/AllPlatformsView';
import SingleCategoryView from '../container/transportComponents/SingleCategoryView';
import ExpandedPlatformDetails from '../container/transportComponents/ExpandedPlatformDetails';
import BottomBar from '../container/transportComponents/BottomBar';

// Import data
import { allPlatforms, tabs } from '../data/transportData/platformsData';
...
function Campaigns() {
  ...
  const handleSaveCampaign = async () => {
    try {
      ...
      const response = await axios.post(
        "https://yepper-backend-ll50.onrender.com/api/transport-campaign",
        campaignData,
        {
          headers: {
  ...
  const fetchCampaigns = async () => {
    try {
      ...
      const response = await axios.get("https://yepper-backend-ll50.onrender.com/api/transport-campaign");
  ...
  const handleUpdateCampaign = async () => {
    try {
      ...
      const response = await axios.put(
        "https://yepper-backend-ll50.onrender.com/api/transport-campaign/${selectedCampaign._id}",
        campaignData,
        {
          headers: {
            'Content-Type': 'application/json'
  ...
  const handleDeleteCampaign = async (campaignId) => {
    try {
      ...
      const response = await axios.delete(
        "https://yepper-backend-ll50.onrender.com/api/transport-campaign/${campaignId}"
      );
