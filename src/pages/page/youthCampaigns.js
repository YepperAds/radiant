...
// Import components
import SearchBar from '../container/youthComponents/SearchBar';
import TabFilter from '../container/youthComponents/TabFilter';
import AllPlatformsView from '../container/youthComponents/AllPlatformsView';
import SingleCategoryView from '../container/youthComponents/SingleCategoryView';
import ExpandedPlatformDetails from '../container/youthComponents/ExpandedPlatformDetails';
import BottomBar from '../container/youthComponents/BottomBar';

// Import data
import { allPlatforms, tabs } from '../data/youthData/platformsData';
...
function Campaigns() {
  ...
  const handleSaveCampaign = async () => {
    try {
      ...
      const response = await axios.post(
        "https://yepper-backend-ll50.onrender.com/api/youth-campaign",
        campaignData,
        {
          headers: {
  ...
  const fetchCampaigns = async () => {
    try {
      ...
      const response = await axios.get("https://yepper-backend-ll50.onrender.com/api/youth-campaign");
  ...
  const handleUpdateCampaign = async () => {
    try {
      ...
      const response = await axios.put(
        "https://yepper-backend-ll50.onrender.com/api/youth-campaign/${selectedCampaign._id}",
        campaignData,
        {
          headers: {
            'Content-Type': 'application/json'
  ...
  const handleDeleteCampaign = async (campaignId) => {
    try {
      ...
      const response = await axios.delete(
        "https://yepper-backend-ll50.onrender.com/api/youth-campaign/${campaignId}"
      );
