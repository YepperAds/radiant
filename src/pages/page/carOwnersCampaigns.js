...
// Import components
import SearchBar from '../container/carOwnerComponents/SearchBar';
import TabFilter from '../container/carOwnerComponents/TabFilter';
import AllPlatformsView from '../container/carOwnerComponents/AllPlatformsView';
import SingleCategoryView from '../container/carOwnerComponents/SingleCategoryView';
import ExpandedPlatformDetails from '../container/carOwnerComponents/ExpandedPlatformDetails';
import BottomBar from '../container/carOwnerComponents/BottomBar';

// Import data
import { allPlatforms, tabs } from '../data/carOwnersData/platformsData';
...
function Campaigns() {
  ...
  const handleSaveCampaign = async () => {
    try {
      ...
      const response = await axios.post(
        "https://yepper-backend-ll50.onrender.com/api/carOwners-campaign",
        campaignData,
        {
          headers: {
  ...
  const fetchCampaigns = async () => {
    try {
      ...
      const response = await axios.get("https://yepper-backend-ll50.onrender.com/api/carOwners-campaign");
  ...
  const handleUpdateCampaign = async () => {
    try {
      ...
      const response = await axios.put(
        "https://yepper-backend-ll50.onrender.com/api/carOwners-campaign/${selectedCampaign._id}",
        campaignData,
        {
          headers: {
            'Content-Type': 'application/json'
  ...
  const handleDeleteCampaign = async (campaignId) => {
    try {
      ...
      const response = await axios.delete(
        "https://yepper-backend-ll50.onrender.com/api/carOwners-campaign/${campaignId}"
      );
