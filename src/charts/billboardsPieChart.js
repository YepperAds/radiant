...
function BillboardsPieChart() {
    const data = [
        { name: 'Akagera Media', value: 1200000, percentage: 12 },
        { name: 'Alliance Media', value: 800000, percentage: 8 }
    ];
...
export default BillboardsPieChart;