...
function RadioLineChart() {
    const data = [
        { name: 'Radio Rwanda', performance: 45 },
        { name: 'Kiss FM', performance: 65 },
        { name: 'Royal FM', performance: 55 },
        { name: 'Contact FM', performance: 75 },
        { name: 'Flash FM', performance: 85 },
        { name: 'Isango Star Radio', performance: 70 },
    ];
